<!-- 
  ...
  git https://github.com/skishore/makemeahanzi
  https://hanziwriter.org/cn/docs.html
 -->
 <template>
  <svg version="1.1" viewBox="0 0 1024 1024">
    {/* 田字格绘制 */}
    <g key="wordBg" stroke="#000" strokeDasharray="1,1" strokeWidth="1" transform="scale(0.4, 0.4)" >
    ...
    {/* 文字svg路径 */}
    <g transform="scale(0.1, -0.1) translate(0, -900)">
      <path v-for="item in strokes" :key="item" :d="item"></path>
    </g>
  </svg>
</template>
<script setup>
